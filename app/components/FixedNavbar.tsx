...
const FixedNavbar = ({ fullNav }: any) => {
    ...
    return (
        <motion.div key='nav' initial='initial' variants={NavAnimations} animate='animate' className='w-auto hidden sm:block fixed   h-auto left-1/2 top-6 opacity-1 z-[7] '>
            {!fullNav ?
                ...
                :
                <AnimatePresence>
                    <motion.div layout key='startNav' exit='exit' variants={NavAnimations} initial='NavInitial' animate='Nav' className=" flex gap-3 justify-center items-center px-6 py-3 w-auto h-[43px] [box-shadow:rgba(0, 0, 0, 0.15)_8px_10px_15px_0px] bg-[#232323] text-[#fff]  rounded-[100px] ">
